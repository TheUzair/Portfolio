            ...
            >
              ...
              >
                <div className="relative flex flex-col md:flex-row max-w-full md:max-w-[600px] cursor-pointer items-center justify-end xl:ml-32 group">
                  ...
                  <div
                    className={`absolute -bottom-4 sm:-bottom-8 md:-bottom-16 -right-1 sm:-right-2 w-1/2 md:mb-14 ${isDarkMode ? "bg-white" : "bg-black"
                      } px-3 py-3 sm:px-4 sm:py-4 md:px-6 md:py-6 md:-right-[150px] xl:py-10 xl:-right-[400px] xl:bottom-20 xl:w-full`}
                  >
                    <h6
                      className={`bg-clip-text text-transparent text-[10px] sm:text-xs font-bold tracking-[2px] sm:tracking-[3px] md:tracking-[4px] md:text-sm xl:text-lg ${isDarkMode
