...
const faqItems = [
  {
    ...
    answer:
      "I offer web development, API development, and consulting services.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "I work with JavaScript, React, Next.js, Node.js, MongoDB, and more.",
  },
  {
    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <motion.h3
            className={`text-5xl lg:text-4xl font-bold mb-2 tracking-wide ${
          ...
          <motion.p
            className={`text-3xl lg:text-7xl font-semibold my-10 tracking-wide ${
          ...
          {faqItems.map((faq, index) => (
            ...
            >
              <Accordion type="single" collapsible>
                ...
                >
                  <AccordionTrigger
                    className={`text-xl sm:text-3xl pb-8 ${
                      isDarkMode
