      ...
      <div className="container mx-auto px-5 py-16 lg:px-20">
        <section id="about">
          ...
          >
            ...
            <motion.p
              className={`text-xl leading-[1.8] ${isDarkMode ? "text-gray-300" : "text-gray-600"
            ...
            >
              ...
              <span
                className={`${isDarkMode ? "text-blue-400" : "text-black"
                  } font-medium`}
              >
                Next.js
              </span>
        ...
        >
          ...
          >
            {skills.map((skill, index) => (
              <div
                key={index}
                className={`flex items-center justify-center rounded-md py-4 px-6 shadow-md ${isDarkMode
