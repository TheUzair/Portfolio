...
const EduExp = () => {
  ...
  return (
    <>
      <section
        id="experience"
        className={`${isDarkMode ? "bg-black text-white" : "bg-gray-50 text-black"
          }`}
      >
        <div className="container mx-auto px-4 lg:px-20">
          ...
          >
            <h1
              className={`text-5xl lg:text-6xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"
                }`}
            >
              Education & Work Experience
            </h1>
            <p
              className={`mt-6 text-xl lg:text-2xl ${isDarkMode ? "text-gray-300" : "text-gray-700"
                }`}
            >
            ...
            >
              ...
              <ul className="mt-8 space-y-8">
                {education.map((edu, index) => (
                  <li
                    key={index}
                    className="group border-b border-gray-300 pb-6"
                  >
                    ...
                    <div
                      className={`flex justify-between text-lg ${isDarkMode ? "text-gray-400" : "text-gray-600"
                        } pt-4`}
                    >
                      <p>{edu.level}</p>
                      <p>{edu.years}</p>
